...
if "%colorSensorCode%"=="1" (
	...
	call :Patch "\\192.168.1.134\UniScan\ColorSensor" "UniScanM.ColorSens.exe" "RawDataTemplate_ColorSensor.xlsx" "UniEyeLauncher_ColorSensor.xml"
